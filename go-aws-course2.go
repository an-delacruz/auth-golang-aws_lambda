...
type GoAwsCourse2StackProps struct {
	awscdk.StackProps
}

func NewGoAwsCourse2Stack(scope constructs.Construct, id string, props *GoAwsCourse2StackProps) awscdk.Stack {
	...
	// example resource
	// queue := awssqs.NewQueue(stack, jsii.String("GoAwsCourse2Queue"), &awssqs.QueueProps{
...
func main() {
	...
	NewGoAwsCourse2Stack(app, "GoAwsCourse2Stack", &GoAwsCourse2StackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
